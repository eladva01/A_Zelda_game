...
def oouts():    
    ...
    bg = pygame.image.load('oouts.png')
    ...
    while run:
            ...
            if Keys[pygame.K_UP] and man.DMUTy >20 :
                            if man.VEL > 0:
                                man.DMUTy -=man.VEL
                                man.down = False
                                man.up = True
            ...
            if Keys [pygame.K_LEFT] and man.DMUTx> 27: 
                        man.DMUTx -=man.VEL
                        man.standing = True
                        man.standing2 = False
                        man.down = False
            ...
            if Keys [pygame.K_RIGHT] and man.DMUTx < 925 :
                            man.DMUTx += man.VEL
                            man.standing = False
                            man.standing2 = True
                            man.down = False
            ...
            if Keys [pygame.K_DOWN] and man.DMUTy < 720 :
                            man.DMUTy +=man.VEL
                            man.down = True
                            man.up = False
                            man.left = False
            ...
            if Keys[pygame.K_SPACE]:
                if man.DMUTx < 650 and man.DMUTx >600 and man and man.DMUTy <130:                    
                    run = False
                    time.sleep(1)
            ...
            if Keys[pygame.K_SPACE]:
                if man.DMUTx < 500 and man.DMUTx >430 and man and man.DMUTy >700:
                    print('out')
                    run = False
                    time.sleep(1)
