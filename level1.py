...
def gaga():
    ...
    class player(object):
        ...
        def draw(self, WIN):
            ...
            if self.up == True:
                ...
                if Keys [pygame.K_SPACE]:
                    if blade.frame_index >9:
                         blade.frame_index =0 
                         
                    pygame.draw.rect(WIN , (255,0,0), blade.hitbox,2)
                    blade.hitbox = (man.DMUTx , man.DMUTy-50, 30,50)
                    print(blade.frame_index)
    ...
    # pygame.draw.rect(WIN, (255, 0, 0), (obs.x, obs.y, obs.w, obs.h),2) #table
        ...
        if Keys[pygame.K_SPACE]:
                if man.DMUTx < 250 and man.DMUTx >100 and man and man.DMUTy <300:
                    door_text= FONT.render('you cannot get out right now!', 1, 'white')
                    WIN.blit(door_text, (man.DMUTx - 100, man.DMUTy -50))
                    run == False
            
                    #from button import Button               
                
                if man.DMUTx < maf.x + maf.w and man.DMUTx + man.DMUTw > maf.x:
                    if maf.y < man.DMUTy + man.DMUTh and maf.y +maf.h> man.DMUTy: 
                        maf_text= FONT.render('You got a key!', 1, 'white')
                        WIN.blit(maf_text, (man.DMUTx - 50, man.DMUTy -30)) 
                        print('key') 
    ...
    while run:
            ...
            if Keys[pygame.K_UP] and man.DMUTy >250 :
                            if man.VEL > 0:
                                man.DMUTy -=man.VEL
                                man.down = False
                                man.up = True
            ...
            if Keys [pygame.K_DOWN] and man.DMUTy < 690 :
                            man.DMUTy +=man.VEL
                            man.down = True
                            man.up = False
                            man.left = False
