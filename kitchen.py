def gagakit():
    ...
    run = True
    bg = pygame.image.load ('nopokehouse.png')
    pygame.display.set_caption('kitchen') #window name
    ...
    while run:
            ...
            if Keys[pygame.K_UP] and man.DMUTy >335 :
                            if man.VEL > 0:
                                man.DMUTy -=man.VEL
                                man.down = False
                                man.up = True
            ...
            if Keys [pygame.K_LEFT] and man.DMUTx> 240: 
                        man.DMUTx -=man.VEL
                        man.standing = True
                        man.standing2 = False
                        man.down = False
            ...
            if Keys [pygame.K_RIGHT] and man.DMUTx < 540 :
                            man.DMUTx += man.VEL
                            man.standing = False
                            man.standing2 = True
                            man.down = False
            ...
            if Keys [pygame.K_DOWN] and man.DMUTy < 520 :
                            man.DMUTy +=man.VEL
                            man.down = True
                            man.up = False
                            man.left = False
    ...
    #man = player(520,395,20,20)
            if Keys[pygame.K_SPACE]:
                if man.DMUTx > 510 and man.DMUTy > 360 and man.DMUTy<420:
                    print (['kitchen exit'])
