...
def arena():    
    ...
    screenW =1800
    screenH = 1000
    WIN =  pygame.display.set_mode((screenW, screenH), pygame.FULLSCREEN) #screen #window 
    pygame.display.set_caption('Elad Game') #window name
    bg = pygame.image.load('arena.png')
    ...
    while run:
            ...
            if Keys[pygame.K_UP] and man.DMUTy >10 :
                            if man.VEL > 0:
                                man.DMUTy -=man.VEL
                                man.down = False
                                man.up = True
            ...
            if Keys [pygame.K_LEFT] and man.DMUTx> 20: 
                        man.DMUTx -=man.VEL
                        man.standing = True
                        man.standing2 = False
                        man.down = False
            ...
            if Keys [pygame.K_RIGHT] and man.DMUTx < 1700 :
                            man.DMUTx += man.VEL
                            man.standing = False
                            man.standing2 = True
                            man.down = False
            ...
            if Keys [pygame.K_DOWN] and man.DMUTy < 920 :
                            man.DMUTy +=man.VEL
                            man.down = True
                            man.up = False
                            man.left = False
            ...
            if Keys[pygame.K_SPACE]:
                if man.DMUTx < 240 and man.DMUTx >140 and man and man.DMUTy >900:
